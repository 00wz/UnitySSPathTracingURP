...
// Hi-Z Tracing
//===================================================================================================================================
// Number of Hi-Z pyramid mip levels supported. Must match HiZPyramidPass.HiZMaxMips (C#) and the _HiZMipInfo array size.
	#define HIZ_MAX_MIPS           12

// Hard iteration cap for the Hi-Z traversal loop, regardless of _HiZMaxSteps.
